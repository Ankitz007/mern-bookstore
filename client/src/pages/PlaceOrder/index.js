...
const PlaceOrder = ({ history }) => {
  ...
  cart.shippingPrice = cart.itemsPrice > 50 ? 0.0 : 10.0;
  cart.totalPrice = Number(
    Number(cart.itemsPrice) + cart.shippingPrice
  ).toFixed(2);
            ...
            <Container>
              <Card>
                <CardContent>
                  ...
                  <Divider />
                  <SummaryItem>
                    Items: <strong>${cart.itemsPrice}</strong>
                  </SummaryItem>
                  <SummaryItem>
                    Shipping: <strong>${cart.shippingPrice}</strong>
                  </SummaryItem>
                  <SummaryItem>
                    Total: <strong>${cart.totalPrice}</strong>
                  </SummaryItem>
                  <ShippingMessage>
                    (Orders above $50 have free shipping)
                  </ShippingMessage>
